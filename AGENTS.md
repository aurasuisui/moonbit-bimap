...
workspace members (they import the *published* `aurasuisui/bimap@0.1.3`, matching indexmap's
...
**AGENTS.md (this) → README.md (product) → CONTRIBUTING.md (how to dev) → `docs/SPEC.md`
