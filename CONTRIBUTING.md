...
│   ├── bbtreemap_diff_test.mbt # Differential vs Rust BiBTreeMap v0.6.3 (sorted terminal)
│   ├── bbtreemap_diff_fixture_test.mbt # generated fixture (by tools/diffgen; test-only)
...
│                          #   PUBLISHED package; standalone, not part of the root package)
├── tools/                 # Dev tooling (diffgen: Rust fixture generator for the
│                          #   differential tests; standalone, not part of the root package)
...
| `bbtreemap_test.mbt` | Unit + Invariant | BiBTreeMap C0–C4, sorted-order/range/first/last, retain, views/entry, traits, minimal-bound pins, QuickCheck sorted-bijection invariants |
| `bbtreemap_diff_test.mbt` | Differential (Tier 1) | Golden C0–C4 + the 6000-step LCG stream + the FULL sorted terminal state vs the **real Rust `bimap` v0.6.3 `BiBTreeMap`**; fixture generated by `tools/diffgen`, checked in |
