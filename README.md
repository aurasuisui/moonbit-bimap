...
[`bimap`](https://crates.io/crates/bimap) crate / Guava `BiMap`, **extended with
...
- **Bijection-enforcing insertion** — `insert` returns an `Overwritten` enum describing what
  was displaced (including the classic C4 collapse, see below)
