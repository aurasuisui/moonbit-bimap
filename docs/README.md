...
| [`plans/v0.2.0.md`](plans/v0.2.0.md) | v0.2.0 详细设计方案(已批准,含真源核验修正;已交付) | 回顾 v0.2.0 决策时 |
| [`plans/v0.3.0.md`](plans/v0.3.0.md) | v0.3.0 详细设计方案 — from_json 反序列化(**有条件批准**(2026-09-04,两轮审核);M1–M5 已交付并发布 v0.3.0(实现+测试 369,发版门禁全绿 2026-09-07)) | 执行 v0.3.0 里程碑时 |
...
| [`申报书.md`](申报书.md) | 2026 MoonBit 9 月黑客松项目申报书(赛道二·社区项目;验收 9/24,核算本期新增) |
